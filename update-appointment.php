                ...
                <form method="POST" >
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="frist_name" oninput="changedata()" onblur="removespantext()" type="text" class="form-control" value="<?php echo $upfet['patient_name']?>" name="patient_name" autofocus>
                    </div>

                    <div class="form-group col-6">
                      <label for="father_name">Patient Father Name</label>
                      <input id="father_name" oninput="changedata1()" onblur="removespantext()" type="text" class="form-control" disabled value="<?php echo $upfet['pfather_name']?>" name="pfather_name">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" oninput="changedata3()" disabled onblur="removespantext()" type="email" value="<?php echo $upfet['pemail']?>" class="form-control" name="pemail">
                  ...
                  <div class="form-group">
                    ...
                    <input id="mobile_number"  oninput="changedata4()" onblur="removespantext()" disabled type="tel" class="form-control" value="<?php echo $upfet['pmobile_number']?>" name="pmobile_number">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="password"  oninput="changedata5()" onblur="removespantext()" disabled  value="<?php echo $upfet['password']?>" type="password" class="form-control pwstrength" data-indicator="pwindicator"
                        name="password">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input id="cpassword" oninput="changedata6()" onblur="removespantext()"name="cpassword" value="<?php echo $upfet['cpassword']?>" type="password" class="form-control" name="password-confirm">
                    </div>
                  </div>
                  <span id='valid3'></span>
                  <div class="form-group">
                    ...
                    <select name="cdoctorname" id="cdoctorname" disabled  class="form-control">
